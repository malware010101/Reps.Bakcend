...
async def upgrade(db: BaseDBAsyncClient) -> str:
    return """
        ALTER TABLE "users" ADD "membresia_plan" VARCHAR(20) NOT NULL DEFAULT 'standard';
        ALTER TABLE "users" ADD "membresia_inicio" TIMESTAMPTZ;
        ALTER TABLE "users" ADD "membresia_estado" VARCHAR(20) NOT NULL DEFAULT 'activa';
        ALTER TABLE "users" ADD "membresia_fin" TIMESTAMPTZ;"""


async def downgrade(db: BaseDBAsyncClient) -> str:
    return """
        ALTER TABLE "users" DROP COLUMN "membresia_plan";
        ALTER TABLE "users" DROP COLUMN "membresia_inicio";
        ALTER TABLE "users" DROP COLUMN "membresia_estado";
        ALTER TABLE "users" DROP COLUMN "membresia_fin";"""
...
MODELS_STATE = (
    ...
    "iafpkf2CZKvTIp3k6Aq7fnPMinOoqAxU93qoCsSm7QSuYqpsNUAY0t5ZzPcjvwMnmzfbvl"
    "7du8UZbYia8Im+bUpjnV9+VlspveoQeazX8KO/RiTJ9nWrzti+cjqta1X+a3y06AIqHsWx"
    "/EjYxVMmrrl0CI81kc29NKIunt5Nd5yvtNEgnpeUAksZdaCiY/aBT7Mp8Lpv3fWKPmdCwc"
    "PWd/YKYHNBAcYjgi7MfTHHvFh+mq+snRKbhge5CNnllH4oRNcrpNbliQlzF+2BW27rr9sH"
    "fQp9Jvg6zXsQsiLXXYHB0tolcfHdUr1jyvdNmFDQ0FiEnxdgJci8swjoktCbZVfzOrIGJu"
    "ZJVN8fRG1lYPaD/+D4o4Ed0="
)
